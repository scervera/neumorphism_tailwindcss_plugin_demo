        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              <Link 
                href="/"
                className="w-10 h-10 bg-slate-200 dark:bg-slate-800 neu-flat hover:neu-pressed rounded-lg flex items-center justify-center transition-all"
              >
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Embossed Thumbnail Design</h1>
                <p className="text-sm text-slate-500 dark:text-slate-400">Images embedded in neumorphic surfaces</p>
              </div>
            </div>
        ...
        {filteredAssets.length === 0 ? (
          ...
          <div className={
            ...
            {filteredAssets.map((asset) => (
              ...
              >
                {/* Embossed container for the image */}
                <div className={`relative ${viewMode === 'grid' ? 'aspect-square m-3' : 'w-24 h-24 m-3'} bg-slate-200 dark:bg-slate-800 neu-pressed rounded-lg overflow-hidden`}>
                  <Image
                    src={asset.path}
                    alt={asset.filename}
                    fill
                  ...
                  <div className="absolute inset-0 rounded-lg ring-2 ring-black/5 dark:ring-white/5 pointer-events-none" />
                </div>
                
                <div className={`px-4 pb-4 ${viewMode === 'list' ? 'flex-1' : ''}`}>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row">
              {/* Embossed image container in lightbox */}
              <div className="flex-1 bg-slate-200 dark:bg-slate-800 p-8 flex items-center justify-center">
                <div className="relative w-full h-96 lg:h-[600px] bg-slate-200 dark:bg-slate-800 neu-pressed rounded-xl overflow-hidden">
                  <Image
                  ...
                  />
                  <div className="absolute inset-0 rounded-xl ring-2 ring-black/5 dark:ring-white/5 pointer-events-none" />
                </div>
              </div>
